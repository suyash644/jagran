...
<?php include('Public_Header.php'); ?>
    ...
    <div class="form-group">
      ...
      <input type="name" class="form-control" id="email" placeholder="Enter Name" name="username">
    </div>
    <div class="form-group">
      <label for="phone">Phone No:</label>
      <input type="phone_no" class="form-control" id="pwd" placeholder="Enter Phone No." name="phone_no">
    </div>
...
<div class="row">
  ...
  <div id="try">
<div id="wrap">
<div class="sub"><a href="#">Shop</a></div>
